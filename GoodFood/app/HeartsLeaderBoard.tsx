...
const HeartsLeaderBoard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchLeaders = async () => {
      try {
        const response = await fetch(`${api}/api/users/getUsersByHearts`); 
  ...
  const renderItem = ({ item, index }: { item: Leader; index: number }) => (
    <View style={styles.tableRow}>
      ...
      <Text style={styles.cell}>{item.hearts}</Text>
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>🏆 Hearts Leaderboard 🏆</Text>
      <View style={styles.tableHeader}>
        <Text style={styles.headerCell}>Rank</Text>
        <Text style={styles.headerCell}>Name</Text>
        <Text style={styles.headerCell}>Email</Text>
        <Text style={styles.headerCell}>Hearts</Text>
